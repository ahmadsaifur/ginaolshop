...
<html>
<head>
 	<title>Transaksi klinik Poligigi Alkindi</title>
<meta charset="utf-8">
						...
						<div class='col-sm-5'>
							<div class="form-horizontal">
								<div class="form-group">
									...
									<div class="col-sm-3">
										<input type='text' id='discc' class='form-control'>
									</div> 
...
// 				$('#TabelTransaksi tbody tr:eq('+Indexnya+') td:nth-child(9) input').val(SubTotal);
// 				// $('#TabelTransaksi tbody tr:eq('+Indexnya+') td:nth-child(9) span').html(SubTotal2);
// 				$('#TabelTransaksi tbody tr:eq('+Indexnya+') td:nth-child(10) input').val(SubTotalVal2);
// 				$('#TabelTransaksi tbody tr:eq('+Indexnya+') td:nth-child(10) span').html(SubTotalVal);

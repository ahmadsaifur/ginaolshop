...
/*
	...
	$("#klik").click(function () {
   	...
   	$("#klik_herbalis").click(function () {
       		...
       		$("#id_herbalis_ori" ).replaceWith( "<select name='nama_herbalis_ori' id='id_herbalis_ori' class='form-control input-sm' style='cursor: pointer;'><option value=''>-- pilih Herbalis --</option><option value='Dr.Faruq'>Dr.Faruq</option><option value=''>----------</option><option value='BM-NS'>BM-NS</option><option value='BM-DN'>BM-DN</option><option value='BM-MT'>BM-MT</option><option value='BM-BW'>BM-BW</option><option value=''>----------</option><option value='AY-DN'>AY-DN</option><option value='AY-MT'>AY-MT</option><option value='AY-NS'>AY-NS</option><option value='AY-NT'>AY-NT</option><option value='AY-BT'>AY-BT</option><option value='AY-BW'>AY-BW</option><option value=''>----------</option><option value='BW-NT'>BW-NT</option><option value='BW-DN'>BW-DN</option><option value='BW-MT'>BW-MT</option><option value='BW-NS'>BW-NS</option><option value='BW-DT'>BW-DT</option><option value=''>----------</option><option value='MT-NS'>MT-NS</option><option value='MT-NT'>MT-NT</option><option value='MT-DT'>MT-DT</option><option value=''>----------</option><option value='NT-NS'>NT-NS</option><option value='NS-DN'>NS-DN</option><option value=''>----------</option><option value='AY-MT-DT'>AY-MT-DT</option><option value='AY-MT-NS'>AY-MT-NS</option><option value='AY-MT-DN'>AY-MT-DN</option><option value='DN-MT-DT'>DN-MT-DT</option> </select>");

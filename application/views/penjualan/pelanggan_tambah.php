...
<div class='form-group'>
	...
	<input type='text' autocomplete="off" name='nama' class='form-control' placeholder="NAMA DITULIS HURUF KAPITAL" oninput='this.value = this.value.toUpperCase()'>
</div>
<div class='form-group'>
	<label>Dokter</label>
	...
	<!--<input type='text' autocomplete="off" name='herbalis' class='form-control' placeholder="TULIS NAMA DOKTER">-->
	<select name='herbalis' class='form-control input-sm' style='cursor: pointer;'>
	    
		<option value=''>-- Pilih Dokter --</option>
		<option value='drg. Tricya'>drg. Tricya</option>
		<option value='drg. Yulia'>drg. Yulia</option>
		<option value='drg. Refi'>drg. Refi</option>
		<option value='drg. Nurlita'>drg. Nurlita</option>
		<option value='drg. Rizky'>drg. Rizky</option>
		<option value='drg. Tien'>drg. Tien</option>
		<option value='drg. Tien'>drg. Bilqis</option>
		<option value='drg. Tien'>drg. Ajeng</option>
